...
def generate_tweet_claude():
    ...
    response = get_anthropic_client().messages.create(
        ...
        messages=[
            {
                "role": "user",
                "content": 'Respond with a single tweet. Dont use hashtags or quotes or mention waddling. Do not include any other text or commentary. Ensure it is not the same as past tweets. Do not start it with Sometimes, be original.'
            }
        ]
    )
